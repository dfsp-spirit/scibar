// scibar example: reversed horizontal diverging colorbar with vik colormap
// Demonstrates low-level API for manual horizontal layout with diverging scale and reversed colormap.
