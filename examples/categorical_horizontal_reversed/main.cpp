// scibar example: reversed categorical horizontal colorbar
// Demonstrates low-level API for manual horizontal layout with reversed categorical scale.
